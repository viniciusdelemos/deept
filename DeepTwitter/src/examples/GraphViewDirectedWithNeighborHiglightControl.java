...
/**
 * A slight variation of the the GraphView example from the prefuse download.
 * This demo shows one way to implement a NeighbourHighLightControl,
 * which uses different colors for source nodes, target nodes and nodes wich are
 * both. This demo needs the file socialnetDirected.xml to work.
 * Search for the string MAD (most amazing discovery) in order to find
 * the changes from the original GraphView source code.   
 * 
 * @author <a href="http://jheer.org">jeffrey heer</a>
 * @author <a href="http://goosebumps4all.net/34all">martin dudek</a>
 */

public class GraphViewDirectedWithNeighborHiglightControl extends JPanel {
    ...
    public GraphViewDirectedWithNeighborHiglightControl(Graph g, String label) {
...
//	opanel.add(overview);
	...
	String datafile = "examples/socialnetDirected.xml";
	String label = "name";
	...
	final GraphViewDirectedWithNeighborHiglightControl view = new GraphViewDirectedWithNeighborHiglightControl(g, label);
	...
	private GraphViewDirectedWithNeighborHiglightControl m_view;
	public GraphMenuAction(String name, String accel, GraphViewDirectedWithNeighborHiglightControl view) {
	    m_view = view;
	...
	public OpenGraphAction(GraphViewDirectedWithNeighborHiglightControl view) {
	    m_view = view;
    ...
    /**
     * MAD - The class, which implements the new highlight control
     * It basically defines three focus groups for source nodes, target nodes
     * and nodes which are both. These focus groups are filled with the respecitve
