 ...
 */
public class ScatterPlotWithAxisLabels extends Display {
	...
	public ScatterPlotWithAxisLabels(Table t, String xfield, String yfield) {
		this(t, xfield, yfield, null);
	}

	public ScatterPlotWithAxisLabels(Table t, String xfield, String yfield, String sfield) {
	...
	private static JToolBar getEncodingToolbar(final ScatterPlotWithAxisLabels sp,
	...
	private static void axisUpdateAction(final ScatterPlotWithAxisLabels sp, 
	...
	public static ScatterPlotWithAxisLabels demo(String data, String xfield,
			String yfield, String sfield) 
	{
		...
		ScatterPlotWithAxisLabels scatter = new ScatterPlotWithAxisLabels(table, xfield, yfield, sfield);
	...
	public static void main(String[] argv) {
		...
		final ScatterPlotWithAxisLabels sp = demo(data, xfield, yfield, sfield);
