...
public class OverviewControl extends ControlAdapter implements PaintListener {
    ...
    private Color OVERVIEW_BACKGROUND = new Color(ColorLib.hex("#4682B47A"), true);
    private Color OVERVIEW_RECTANGLE = new Color(ColorLib.hex("#A6A8FA"), true);
    ...
    private void drawClearRectangle(Graphics2D g) {
        ...
        g.setColor(OVERVIEW_BACKGROUND);
