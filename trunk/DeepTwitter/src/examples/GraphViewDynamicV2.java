...
public static final int NODES_PER_ROUND = 10; 
public static final int MILISEC_BETWEEN_ROUNDS = 5000; 
...
public synchronized void run() { //MAD synchronizing the modification process 
