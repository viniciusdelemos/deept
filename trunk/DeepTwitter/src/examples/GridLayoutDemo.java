...
public class GridLayoutDemo extends JFrame {
    ...
    static JComboBox horGapComboBox;
    static JComboBox verGapComboBox;
    ...
    public static void initGaps() {
        horGapComboBox = new JComboBox(gapList);
        verGapComboBox = new JComboBox(gapList);
    }
    
    public static JScrollPane addComponentsToPane() {
        initGaps();
        ...
        return new JScrollPane(compsToExperiment);
